...
class SarvamMNLUProcessor:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.emergency_keywords = {
            ...
            'hi': ['आपातकाल', 'तुरंत', 'सीने में दर्द', 'दिल का दौरा', 'बेहोश', 'तात्कालिक', 'छाती में दर्द', 'पक्षाघात', 'रक्तस्राव', 'बेहोश'],
            'ta': ['அவசரம்', 'உடனடி', 'அவசர நிலை', 'அவசர', 'மார்பு வலி', 'இதயத் தாக்கம்', 'ஸ்ட்ரோக்', 'இரத்தப்போக்கு', 'அறியாமை'],
            'te': ['అత్యవసరం', 'తక్షణం', 'అత్యవసర', 'ఛాతి నొప్పి', 'గుండెపోటు', 'స్ట్రోక్', 'రక్తస్రావం', 'అవగాహన లేని'],
            'bn': ['জরুরি', 'তাৎক্ষণিক', 'বুকে ব্যথা', 'হার্ট অ্যাটাক', 'স্ট্রোক', 'রক্তপাত', 'অজ্ঞান'],
            'mr': ['आपत्कालीन', 'तातडीचे', 'छातीत दुखणे', 'हृदयविकार', 'पक्षाघात', 'रक्तस्राव', 'बेशुद्ध'],
            'kn': ['ತುರ್ತು', 'ಹೃದಯದ ನೋವು', 'ಹೃದಯಾಘಾತ', 'ಅಘಾತ', 'ರಕ್ತಸ್ರಾವ', 'ಅಚೇತನ'],
            'ml': ['അടിയന്തരാവസ്ഥ', 'അടിയന്തര', 'ഹൃദയ വേദന', 'ഹൃദയാഘാതം', 'സ്ട്രോക്ക്', 'രക്തസ്രാവം', 'അചേതന'],
        }
